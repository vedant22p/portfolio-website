  ...
  const experience = [
    {
      ...
      description:
        "Spearheading the development of a LangChain-based conversational AI chatbot for the Jal Jeevan Mission (JJM), as part of a project with the Ministry of Jal Shakti under the payroll of ADG Online Solutions Pvt. Ltd. The chatbot supports both public-facing and internal queries using dynamic intent recognition, integrated with NIC-secured APIs, and manages large-scale, frequently updating datasets from nationwide water infrastructure systems. Engineering Python-based automation pipelines and interactive dashboards for monitoring and visualizing water resource data, drastically improving decision-making speed and stakeholder access to real-time insights. Built a Water Quality Management AI model to ensure access to safe and clean drinking water across India, analyzing 20–30 physicochemical parameters per state across India, including pH, turbidity, fluoride, magnesium, nitrate, iron, and others, enabling intelligent quality assessments, early warnings, and targeted interventions at scale.",
      status: "Ongoing",
